...
function Admin() {
    ...
    const fetchAll = async () => {
        try {
            const [statsRes, prestRes, clientRes] = await Promise.all([
    ...
    return (
        <div style={{ backgroundColor: '#080808', paddingTop: '100px', minHeight: '100vh' }}>
            <div style={{ maxWidth: '1300px', margin: '0 auto', padding: '0 40px 80px' }}>
                ...
                {/* Tabs */}
                <div style={{ display: 'flex', gap: '5px', marginBottom: '50px', borderBottom: '1px solid rgba(197,160,89,0.15)', paddingBottom: '0' }}>
                    {tabs.map(tab => (
                        <button
                            key={tab.key}
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '20px', marginBottom: '50px' }}>
                            {[
                                ...
                                <div key={i} className="glass-card" style={{ padding: '25px', textAlign: 'center' }}>
                                    <h3 style={{ color: s.color, fontSize: '2rem', fontFamily: 'Cormorant Garamond, serif', margin: 0 }}>
                                        {s.value}
                                    </h3>
                                    <p style={{ color: 'rgba(232,224,208,0.4)', fontSize: '0.55rem', letterSpacing: '3px', marginTop: '8px', marginBottom: 0 }}>
                                        {s.label}
                                    </p>
                                </div>
                            ))}
                            ...
                            {[...prestataires]
                                ...
                                .map((p, i) => (
                                    <div key={p.id} style={{
                                        ...
                                        padding: '15px 0',
                                        borderBottom: i < 4 ? '1px solid rgba(197,160,89,0.1)' : 'none',
                                    }}>
                                        <span style={{ color: '#C5A059', fontSize: '1.2rem', fontFamily: 'Cormorant Garamond, serif', width: '30px' }}>
                                            #{i + 1}
                                        </span>
                                        <div style={{
                                            ...
                                            color: '#C5A059', fontSize: '1rem', flexShrink: 0,
                                        }}>
                                        ...
                                        <span style={{
                                            padding: '3px 12px', fontSize: '0.55rem', letterSpacing: '2px',
                                            border: `1px solid ${p.is_active ? 'rgba(40,167,69,0.4)' : 'rgba(220,53,69,0.4)'}`,
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px' }}>
                            ...
                            <input
                                ...
                                style={{
                                    ...
                                    color: '#e8e0d0', padding: '10px 20px',
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '25px' }}>
                            {filteredPrestataires.map(p => (
                                <div key={p.id} className="glass-card" style={{
                                    padding: '30px',
                                    borderLeft: `2px solid ${p.is_active ? 'rgba(40,167,69,0.4)' : 'rgba(220,53,69,0.4)'}`,
                                    ...
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '20px' }}>
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                                            <div style={{
                                                ...
                                                border: '1px solid rgba(197,160,89,0.3)',
                                                display: 'flex', alignItems: 'center', justifyContent: 'center',
                                                color: '#C5A059', fontSize: '1.2rem', flexShrink: 0,
                                                background: 'rgba(197,160,89,0.05)',
                                            }}>
                                                {p.username.charAt(0).toUpperCase()}
                                            </div>
                                            <div>
                                                ...
                                                <span style={{
                                                    padding: '2px 10px', fontSize: '0.55rem', letterSpacing: '2px',
                                                    border: `1px solid ${p.is_active ? 'rgba(40,167,69,0.4)' : 'rgba(220,53,69,0.4)'}`,
                                                    color: p.is_active ? '#28a745' : '#dc3545',
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginBottom: '20px' }}>
                                        {[
                                            { icon: '✉', value: p.email || '—' },
                                            { icon: '📞', value: p.telephone || '—' },
                                            { icon: '📍', value: p.adresse || '—' },
                                        ].map((item, i) => (
                                    ...
                                    <button
                                        ...
                                        style={{
                                            width: '100%', padding: '12px', fontSize: '0.6rem',
                                            borderColor: p.is_active ? 'rgba(220,53,69,0.4)' : 'rgba(40,167,69,0.4)',
                                            color: p.is_active ? '#dc3545' : '#28a745',
                                        }}
                        ...
                        <div className="glass-card" style={{ padding: '10px 40px' }}>
                            {clients.map((c, i) => (
                                <div key={c.id} style={{
                                    ...
                                    padding: '18px 0',
                                    borderBottom: i < clients.length - 1 ? '1px solid rgba(197,160,89,0.08)' : 'none',
                                }}>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
                                        <div style={{
                                            ...
                                            border: '1px solid rgba(197,160,89,0.2)',
                                            display: 'flex', alignItems: 'center', justifyContent: 'center',
                                            color: '#C5A059', fontSize: '0.9rem', flexShrink: 0,
                                        }}>
                                    ...
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
                                        <span style={{
                                            padding: '3px 12px', fontSize: '0.55rem', letterSpacing: '2px',
                                            border: `1px solid ${c.is_active ? 'rgba(40,167,69,0.4)' : 'rgba(220,53,69,0.4)'}`,
                                        ...
                                        <button
                                            className="gold-button"
                                            style={{
                                                padding: '8px 18px', fontSize: '0.55rem',
                                                borderColor: c.is_active ? 'rgba(220,53,69,0.4)' : 'rgba(40,167,69,0.4)',
                                                color: c.is_active ? '#dc3545' : '#28a745',
                                            }}
